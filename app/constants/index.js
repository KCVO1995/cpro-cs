 ...
 * :date last edited: 2022-08-02 14:22:01
 */

'use strict';
const APIS = {
  GET_WX_TOKEN: 'https://api.weixin.qq.com/cgi-bin/token',
  GET_WX_UNION_ID: 'https://api.weixin.qq.com/cgi-bin/user/info',
  ...
  IMPORT_AFTER_SALE:
    'https://dopen.weimob.com/apigw/weimob_shop/v2.0/rights/omni/import',
